...
namespace Journey.Api.Controllers
{
    ...
    public class TripsController : ControllerBase
    {
        ...
        public IActionResult Register([FromBody] RequestRegisterTripJson request)
        {
            ...
            return Created(string.Empty, response); // Responsavel por preencher o StatusCode como 201
        }
        ...
        // Não pode ter 1 ou mais Get ou Post, para isso usamos o Route
        [HttpGet]
        [Route("{id}")]
        ...
        // Cadastrar uma atividade para viagem
        [HttpPost]
